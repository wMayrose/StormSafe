        ...
        NavigationStack {
            ZStack {
                VStack (spacing: 20){
                    ...
                    NavigationLink(destination: Text("Tornados are violently rotating columns of air extending from thunderstorm to the grounds with winds that can exceed 300 mph and can form rapidly with little warning. \r \r The key to survival is having a predetermined shelter plan and acting immediately when warnings are issued seek shelter in a basement or interior room on the lowest floor of a sturdy building, away from windows. \r \r If caught outdoors, lie flat in a low area like a ditch and cover your head with your hands, but never shelter under highway overpassess as they create dangerous wind tunnels. \r \r Mobile homes offer no protection and should be abandoned immediately for sturdier shelter. A tornado watch means conditions are favorable for tornado development, while a tornado warning meands one has been spotted and you should take shelter immediately. The distinctive roaring sound, often described as a freight train, may be your only warning in some cases.")
                        .font(.body)
                        .fontWeight(.medium)
